...
// The HTML/CSS already creates the main automation network.
// JavaScript adds subtle moving particles and mouse interaction.
...
function drawParticles() {
  ...
  for (let i = 0; i < particles.length; i++) {
    ...
    // Mouse creates a very subtle attraction/repulsion effect.
    if (mouse.x !== null) {
